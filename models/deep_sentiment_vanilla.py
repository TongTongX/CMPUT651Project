...
class DeepSentimentVanillaModel(nn.Module):
    def __init__(self, *args, **kwargs):
        ...
        self.infersent.load_state_dict(torch.load(os.path.join(os.getcwd(), '../data/encoder/infersent1.pkl')))
        self.infersent.set_w2v_path(w2v_path=os.path.join(os.getcwd(), '../data/glove/glove.840B.300d.txt'))
    ...
    def forward(self, image_batch, text_batch):
        ...
        embeddings = self.infersent.encode(text_batch, bsize=self.batch_size, tokenize=False, verbose=False)
