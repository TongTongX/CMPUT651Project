...
#     X_batch, y_batch = sample2data(sample,4)
#     print(X_batch)
...
data = dataiter.next()
images, labels = data['image'],data['overall_sentiment_ternary_int']
...
for epoch in range(2):  # loop over the dataset multiple times
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        inputs, labels = data['image'],data['overall_sentiment_ternary_int']
